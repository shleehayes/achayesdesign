...
<head>
	...
	<link rel="stylesheet" href="lib/font-awesome/css/font-awesome.min.css" text="type/css">
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#portfolioModal9" class="portfolio-link" data-toggle="modal">
						...
						<img src="img/portfolio/09-thumbnail.png" class="img-fluid" alt="">
					</a>
					<div class="portfolio-caption">
						<h4>Groot</h4>
						<p class="text-muted">Digital Illustration</p>
...
<!-- Footer -->
	<footer>
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<span class="copyright">Copyright &copy; <?php echo date('Y'); ?> AC Hayes Design. All rights reserved.</span>
				</div>
			</div>
		</div>
	</footer>
